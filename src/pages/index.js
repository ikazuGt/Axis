...
export default function Home() {
  ...
  const handleStartQuiz = () => {
    ...
    // Here you would navigate to the quiz page or show the quiz interface
  };
              ...
              {[...Array(6)].map((_, i) => (
                <motion.div
                  ...
                  className={`absolute rounded-full ${
                    i % 2 === 0 ? "bg-sky-300" : "bg-indigo-300"
                  }`}
                  style={{
              ...
              <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-center">
                <div className="md:col-span-3">
                  ...
                  >
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-8 leading-tight tracking-tight">
                      Learn to Code with <br className="hidden sm:block" />
                    ...
                    <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-xl">
                      Axis helps you master programming through personalized AI
                      roadmaps, interactive learning, and knowledge-testing
                      quizzes.
                    </p>
                ...
                >
                  ...
                  <div className="relative h-full w-full">
                    ...
                    <div className="absolute inset-0 rounded-2xl overflow-hidden bg-gradient-to-br from-white to-sky-50 border border-gray-100 shadow-xl">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center justify-center p-6">
                        <div className="z-10 flex flex-col items-center">
                          ...
                          <p className="text-gray-600 mt-4 text-center max-w-xs">
                            Chat with our AI to create personalized learning
                            paths tailored to your goals
                          </p>

                          {/* Code snippets */}
                          <motion.div
                            className="absolute top-8 -right-6 max-w-[160px] bg-white p-2 rounded border border-gray-100 shadow-md opacity-90 transform rotate-6"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                          ...
                          <motion.div
                            className="absolute bottom-8 -left-6 max-w-[160px] bg-white p-2 rounded border border-gray-100 shadow-md opacity-90 transform -rotate-3"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Our AI-powered platform makes learning programming concepts
                ...
                {[
                  ...
                  >
                    <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-sky-100 to-blue-50 flex items-center justify-center mb-6">
                      <div className="text-gradient-sky">{feature.icon}</div>
                    </div>
          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Start your coding journey with these simple steps
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                {[
                  {
                    icon: <FaRobot className="text-sky-500" size={32} />,
                    title: "Chat with AI",
                    description:
                      "Tell our AI what programming topics you want to learn",
                  },
                  {
                    icon: <MdSchool className="text-sky-500" size={32} />,
                    title: "Get Your Roadmap",
                    description:
                      "Receive a personalized learning path and key concepts",
                  },
                  {
                    icon: <FaCode className="text-sky-500" size={32} />,
                    title: "Study Materials",
                    description:
                      "Access curated resources for each topic in your roadmap",
                  },
                  {
                    icon: <FaChartLine className="text-sky-500" size={32} />,
                    title: "Test Knowledge",
                    description: "Take quizzes to reinforce your understanding",
                  },
                ].map((step, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="w-16 h-16 flex items-center justify-center bg-gradient-to-br from-sky-100 to-blue-50 rounded-full mb-6 z-10 shadow-sm">
                      {step.icon}
                    </div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-3">
                      {step.title}
                    ...
                    {/* Better positioned arrows between steps */}
                    {index < 3 && (
                      <div className="hidden lg:flex absolute left-[calc(100%+8px)] top-8 w-12 -translate-x-1/2 items-center justify-center">
                        <motion.div
                    ...
                    <div className="lg:hidden absolute top-8 left-full transform -translate-x-1/2 -translate-y-1/2 text-sky-500">
                      {index < 3 && "→"}
                    </div>
                  </motion.div>
                ))}

                {/* Connection line behind the icons - with subtle gradient pulse animation */}
                <motion.div
                  className="hidden lg:block absolute top-8 left-0 right-0 h-0.5 bg-gradient-to-r from-sky-100 to-blue-100 z-0"
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Join Axis today and get personalized guidance from our AI
